...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: zEYCwWZ-pv4/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: I-YmR_8FdnC/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__pOof)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__lWOyb)}
              />
            </React.Fragment>
          ),
