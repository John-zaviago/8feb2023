...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: wPKn7yeZD86/component
import Select__Option from "../../Select__Option"; // plasmic-import: bpAVT12l6AT/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic_zaviago_react_builder.module.css"; // plasmic-import: gVLjp5jEanpB9JmP1wfhu5/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: I-YmR_8FdnC/css
import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: 2wDxeWxwZeV/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: hazIDmPDlTU/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__p4F23)}
            value={"value1"}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__uwXJi)}
            value={"value2"}
          >
            {"Option 2"}
          </Select__Option>
