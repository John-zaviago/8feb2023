...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: VEoZuKV-qCO/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: aZ3Cuno_KTq/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg___2SjzW)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___1CedE)}
                role={"img"}
              />
            ),
