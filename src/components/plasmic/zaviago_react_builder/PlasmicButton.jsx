...
import sty from "./PlasmicButton.module.css"; // plasmic-import: OiEpCGxwidZ/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: rDkz_xdeJbB/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 9PWw2RrCoUo/icon
...
function PlasmicButton__RenderFunc(props) {
  ...
  const stateSpecs = React.useMemo(
    () => [
      ...
      {
        path: "buttonWithBorder",
        type: "private",
        variableType: "variant",
        initFunc: true
          ? ($props, $state, $ctx) => $props.buttonWithBorder
          : undefined
      }
    ],
    ...
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootbuttonWithBorder]: hasVariant(
            $state,
            "buttonWithBorder",
            "buttonWithBorder"
          ),

          [sty.rootbuttonWithBorder_showStartIcon]:
            hasVariant($state, "showStartIcon", "showStartIcon") &&
            hasVariant($state, "buttonWithBorder", "buttonWithBorder"),
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___2MJS)}
                role={"img"}
              />
            ),
        ...
        {p.renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            [sty.slotTargetChildren___focusVisibleWithin]:
              triggers.focusVisibleWithin_root,
            [sty.slotTargetChildrenbuttonWithBorder]: hasVariant(
              $state,
              "buttonWithBorder",
              "buttonWithBorder"
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__f2M6I)}
                role={"img"}
              />
            ),
